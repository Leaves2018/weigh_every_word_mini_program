...
另外如果你还没有在小程序中登记你的学号的话，麻烦通过“我”页面的“用户设置”入口，登记一下你的学号和邮箱。这有助于我们将你的使用数据与你的词汇量、考试成绩关联起来。另外，在研究接近尾声时，我们也将邀请一些数据上比较有代表性（例如词汇量提升最多、使用记录最多等）的同学进行访谈，并送上一些小礼物。
